...
**96 components** — 58 Fit · 12 HOLD · 19 DNP · 7 TBD. **25** entries still use `VERIFY` placeholder package names.
...
| C002 | U2 | RK806S-5 | R-Temple Compute Board | HOLD | `AI_Glasses_V2:VERIFY_QFN` | VERIFY placeholder; not layout/fab ready | G03 (RK806S MPN/inductors/caps/timing per Radxa/Rockchip FAE) |
| C003 | U3 | LPDDR4X 4GB (MPN TBD) | R-Temple Compute Board | HOLD | `AI_Glasses_V2:VERIFY_BGA` | VERIFY placeholder; not layout/fab ready | G02 (LPDDR4X MPN/topology/placement, DDR review + length report) |
| C004 | U4 | eMMC 5.1 32GB (MPN TBD) | R-Temple Compute Board | HOLD | `AI_Glasses_V2:VERIFY_BGA153` | VERIFY placeholder; not layout/fab ready | G04 (eMMC MPN + BSP/bootloader; cold-boot + power-loss recovery) |
...
| C008 | L1 | Boost inductor (TBD) | R-Temple Compute Board | TBD | `AI_Glasses_V2:VERIFY_L_5x5` | VERIFY placeholder; not layout/fab ready | G06/G13 (Isat covers boot+AI peak; height <=2mm; thermal) |
...
| C017 | J7 | Wi-Fi 2.4/5 GHz FPC ant | Temple Rears (batt/spkr/ant) | TBD | `AI_Glasses_V2:VERIFY_ANT` | VERIFY placeholder; not layout/fab ready | Head-loaded RSSI/throughput/SAR; keep-out |
| C018 | J6 | BLE 2.4 GHz FPC/PCB ant | Temple Rears (batt/spkr/ant) | TBD | `AI_Glasses_V2:VERIFY_ANT` | VERIFY placeholder; not layout/fab ready | Worn-state tuning; clear of battery/metal |
| C019 | U14 | IMX415-AAQR module (custom FPC) | Front Sensor Board | HOLD | `AI_Glasses_V2:VERIFY_CAM_MODULE` | VERIFY placeholder; not layout/fab ready | G10 (module lens/FOV/FPC pinout/lane/supply/timing from vendor) |
...
| C025 | LS1 | 8 ohm 0.5-1 W speaker | Temple Rears (batt/spkr/ant) | TBD | `AI_Glasses_V2:VERIFY_SPK` | VERIFY placeholder; not layout/fab ready | MPN after acoustic cavity/volume/leak test |
...
| C032 | U23 | BQ2970 | L-Temple AON/Power Board | DNP | `Package_TO_SOT_SMD:SOT-23-5` | KiCad-library candidate; verify against MPN package drawing | Keep ONE protection scheme; confirm suffix OVP/UVP/OCP vs nPM1300/boost UVLO (§17) |
| C032-BYP | R21 | 0R (pack-PCM baseline) | L-Temple AON/Power Board | Fit | `AI_Glasses_V2:R_0805` | generic passive placeholder; freeze after passive MPN/derating | Populate 0R OR discrete protection, never both (§17) |
| C032-Cv | C2 | 0.1uF | L-Temple AON/Power Board | DNP | `AI_Glasses_V2:C_0402` | generic passive placeholder; freeze after passive MPN/derating | Per BQ2970 app |
| C032-Q | Q1 | Dual N-MOSFET (b2b) | L-Temple AON/Power Board | DNP | `AI_Glasses_V2:VERIFY_DFN_2FET` | VERIFY placeholder; not layout/fab ready | Vds/RDSon/Vgs/peak per BQ2970 app (§17) |
| C032-Rm | R23 | 2k | L-Temple AON/Power Board | DNP | `AI_Glasses_V2:R_0402` | generic passive placeholder; freeze after passive MPN/derating | Per BQ2970 app (V- sense) |
| C032-Rv | R22 | 330R | L-Temple AON/Power Board | DNP | `AI_Glasses_V2:R_0402` | generic passive placeholder; freeze after passive MPN/derating | Per BQ2970 app |
...
| C033a | RT1 | 10k NTC (R cell) | Temple Rears (batt/spkr/ant) | Fit | `AI_Glasses_V2:R_0402` | generic passive placeholder; freeze after passive MPN/derating | NTC curve matched to nPM1300 charger config |
| C033b | RT2 | 10k NTC (L cell) | Temple Rears (batt/spkr/ant) | Fit | `AI_Glasses_V2:R_0402` | generic passive placeholder; freeze after passive MPN/derating | NTC curve matched to nPM1300 charger config |
| C034 | J1 | Magnetic pogo 4-6p | Temple Rears (batt/spkr/ant) | TBD | `AI_Glasses_V2:VERIFY_POGO` | VERIFY placeholder; not layout/fab ready | Magnet direction, sweat corrosion, short, cycle life |
...
| C038 | J3 | Hirose FH26W 0.3mm FPC | Front Sensor Board | HOLD | `AI_Glasses_V2:VERIFY_FPC_FH26W` | VERIFY placeholder; not layout/fab ready | G12 (pin count from final cam lane/mic/power split) |
| C039 | J4 | Custom hinge FPC 6-10mm | Temple Rears (batt/spkr/ant) | HOLD | `AI_Glasses_V2:VERIFY_HINGE_FPC` | VERIFY placeholder; not layout/fab ready | G12 (impedance, bend radius, life, hinge interference) |
| C040 | J5 | U.FL / I-PEX MHF | Temple Rears (batt/spkr/ant) | Fit | `Connector_Coaxial:U.FL_Hirose_U.FL-R-SMT-1_Vertical` | KiCad-library candidate; verify against MPN package drawing | Connector height + mating life |
